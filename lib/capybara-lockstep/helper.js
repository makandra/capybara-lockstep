window.CapybaraLockstep = (function() {
  ...
  function trackTurbo() {
    ...
    // just before fetch(). Since microtasks run before rAF callbacks, calling
    // startWork() here ensures the work is registered before our click event's
    // stopWorkNow fires (which is scheduled via rAF + setTimeout).
